...
module.exports = NodeHelper.create({
	...
	saveDepartures: function(data) {
		...
		for (var i in data.Departure) {
			...
			var departureTransportNumber = departure.ProductAtStop.num; //departure.transportNumber; changed for 2.1
			var departureTo = departure.direction;
			var departureType = departure.ProductAtStop.catOutS; //departure.Product.catOutS; changed for 2.1
